...
const MainSection: FC<MainSectionType> = ({currentMode, setCurrentMode}) => {
    ...
    return (
        <div className="col-start-3 col-end-11 flex flex-col items-center">
            ...
            <p className="col-end-11 mb-16 text-center text-2xl">Our web app tracks your crypto transactions and helps you find the best exchanges.</p>
